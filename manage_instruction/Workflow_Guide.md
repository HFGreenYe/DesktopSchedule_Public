...
给执行窗口的小工单提示词应尽量短而完整，避免反复解释阶段背景。推荐固定包含五部分：
...
除非任务边界容易误解，否则不要在执行提示词里加入长篇架构说明、历史复核结论或与当前小工单无关的阶段信息。阶段背景和长期规划应主要留在 `Work_Instruction.md`、`Work_Formulation.md` 或历史归档文件中。
