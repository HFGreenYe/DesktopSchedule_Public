...
class AppConfig:
    ...
    #COLOR_GRADIENT_START = "#1E90FF" #天蓝
    #COLOR_GRADIENT_END = "#1D9FFF"
    ...
    #COLOR_GRADIENT_START = "#15AC70" #茂绿
    #COLOR_GRADIENT_END = "#01C260"

    #COLOR_GRADIENT_START = "#17BE7B" #"#17BE7B" #翠绿
    #COLOR_GRADIENT_END = "#36C38A"   #"#2DC387"

    #COLOR_GRADIENT_START = "#C62828" #绯红
    #COLOR_GRADIENT_END = "#EF5350"

    #COLOR_GRADIENT_START = "#689F38" #芽绿
    #COLOR_GRADIENT_END = "#9CCC65"
